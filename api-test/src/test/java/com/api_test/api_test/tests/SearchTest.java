 ...
 * 1. Kiểm tra từ khóa hợp lệ 'avengers' và 'doraemon' (Tiếng Việt).
 * 2. Xác thực cấu trúc dữ liệu Search (status: success, data: not null).
 * 3. Kiểm tra các tham số phân trang (currentPage, totalItems).
 * 4. Kiểm tra tham số giới hạn kết quả (limit=3).
 * 5. Xác thực TitlePage chứa từ khóa tìm kiếm.
 * 6. Kiểm tra xử lý từ khóa rác hoặc quá ngắn (Single character).
 * 7. Kiểm tra phân trang Search (Trang 1 khác Trang 2).
 * 8. Kiểm tra xử lý khi không có từ khóa (No keyword).
 * 9. Demo báo cáo lỗi message sai (Intentional FAIL).
 */
...
public class SearchTest extends BaseTest {
    ...
    // data.params.pagination = { currentPage, totalItems, totalItemsPerPage,
    // totalPages }
    // ============================================================
    ...
    // .then()
    // .statusCode(200)
    // // Thực tế message là "Tìm kiếm thành công", test mong muốn chữ khác để ép
    // Fail
